  ...
  render() {
    return (
      <TabNavigation tabBarHeight={56} initialTab="home">
        ...
        <TabNavigationItem
          id="agenda"
          renderIcon={isSelected => this._renderIcon('list-alt', isSelected)}>
          <StackNavigation initialRoute="agenda" />
        </TabNavigationItem>

		<TabNavigationItem
		  id="checklist"
		  renderIcon={isSelected => this._renderIcon('check', isSelected)}>
		  <StackNavigation initialRoute="checklist" />
		</TabNavigationItem>
  ...
  _renderIcon(name, isSelected) {
    return (
      <FontAwesome
        name={name}
        size={32}
        color={isSelected ? '#00008f' : Colors.tabIconDefault}
      />
    );
  }
